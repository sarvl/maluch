...
logic kclk_test;
    ...
    (* MARK_DEBUG = "true" *) logic kclkf, kdataf, p_kclkf;
    (* MARK_DEBUG = "true" *) logic [7:0] datacur;
    logic [7:0] datacur_nxt;
    logic [7:0] dataprev, dataprev_nxt;
    (* MARK_DEBUG = "true" *) logic [3:0] cnt;
    logic [3:0] cnt_nxt;

    (* MARK_DEBUG = "true" *) logic shifting;
    logic shifting_nxt;
    ...
    (* MARK_DEBUG = "true" *) logic [15:0] data_buffer;
    logic [15:0] data_buffer_nxt;

    (* MARK_DEBUG = "true" *) logic is_break;
    assign is_break = (dataprev == 8'hF0);

    (* MARK_DEBUG = "true" *) logic ready_reg;
    assign ready_reg = ~busy_flag;

    logic [13:0] timeout_cnt;
...
always_ff @(posedge clk or negedge rstn) begin
    if(!rstn) begin
        ...
        // Timeout counter increments when cnt is non-zero and clock is idle
        if (!kclkf && p_kclkf) begin
            timeout_cnt <= 0;
        end else if (cnt != 0) begin
            if (timeout_cnt < 14'd12000) begin
