...
module core(
    ...
    // Latch instruction on negedge to ensure stability for writeback
    always_ff @(negedge clk) instruction_ir <= mem2core_instr;
    // Driving outputs
    ...
    assign instruction = irq_f ? int_instr : instruction_ir;
